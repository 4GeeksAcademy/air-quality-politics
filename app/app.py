...
import requests
from preprocesamiento import preparar_datos  # Asegúrate de que está en el mismo directorio o ajusta la ruta

# Configuración de página
st.set_page_config(page_title="Predicción de Mortalidad", layout="centered")
st.write("✅ La app se ha iniciado correctamente.")

# Provincias y códigos
provincias_codigos = {
...
url_modelo_hf = "https://huggingface.co/ullaom/rf_pre_covid.pkl/resolve/main/modelo_rf_pre_covid.pkl"
ruta_modelo_local = "models/modelo_rf_pre_covid.pkl"
...
descargar_modelo_si_no_existe(url_modelo_hf, ruta_modelo_local)
